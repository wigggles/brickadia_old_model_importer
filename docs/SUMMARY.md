# obj2brz (Brickadia OBJ -> BRZ converter)

## What this repo is

This repository contains `obj2brz`, a Rust tool that converts a 3D model exported as a Wavefront `.obj` (optionally with `.mtl` + texture images) into a Brickadia save file (`.brz`). The generated save is a voxelized version of the model built out of Brickadia bricks/tiles/microbricks.

This is an adaptation for Brickadia “a5” of Suficio’s `textured-voxelizer`.

pre compiled versions:
https://github.com/Kmschr/obj2brz/releases
