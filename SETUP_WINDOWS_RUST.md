# Windows Setup (Rust) for obj2brs

This guide walks through setting up and running `obj2brs` on **Windows 11** using **PowerShell**.
...
By default, `obj2brs` selects Brickadia’s Builds folder on Windows:
